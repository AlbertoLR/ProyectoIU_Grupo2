...
$view->setVariable("title", "Delete Payment");
...
<div class="jumbotron">
  ...
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item active"><?= i18n("Delete Payment") ?></li>
    ...
    <div class="container">
        <h1><?= i18n("Delete Payment")." ".$payment->getID()?></h1>
      <form payment="index.php?controller=payment&amp;action=delete" method="POST">
