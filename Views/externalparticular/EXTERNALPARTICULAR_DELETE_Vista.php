...
$view->setVariable("title", "Delete External Particular");
...
<div class="design">
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item active"><?= i18n("Delete External Particular:") ?></li>
  </ol>
  </div>
    <div class="container">
        <h1><?= i18n("Delete External Particular:")." ".$externalparticular->getNombre()?></h1>
      <form action="index.php?controller=externalparticular&amp;action=delete" method="POST">
