...
<div class="design">
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item active"><?= i18n("Search External Particular") ?></li>
  </ol>
  </div>
    <div class="container">
      <h1><?= i18n("Search External Particular")?></h1>
      <form action="index.php?controller=externalparticular&amp;action=search" method="POST">
