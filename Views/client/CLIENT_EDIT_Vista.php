      ...
      <h1><?= i18n("Modify Client")?></h1>
        <form action="index.php?controller=client&amp;action=edit" method="POST" enctype="multipart/form-data">
          <div class="form-group">
            ...
            <input type="text" name="dni" id="dni" class="form-control" value="<?= $client->getDni()?>" placeholder="ej: 00000000A" minlength="9" maxlength="9" required="required" pattern="(([X-Zx-z]{1})([-]?)(\d{7})([-]?)([A-Za-z]{1}))|((\d{8})([-]?)([A-Za-z]{1}))" >
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            <label><?= i18n("Phone") ?>:</label>
             <input type="number" name="phone" value="<?= $client->getPhone()?>" placeholder="ej: 666777888" pattern="^[9|8|7|6]\d{8}$" class="form-control">
          </div>
          <div class="form-group">
