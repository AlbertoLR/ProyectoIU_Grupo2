...
$view->setVariable("title", "Create Document");
...
<div class="jumbotron">
  ...
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item active"><?= i18n("Create Document") ?></li>
  </ol>
  </div>
    <div class="container">
      <h1><?= i18n("Create Document")?></h1>
        <form action="index.php?controller=document&amp;action=add" method="POST" enctype="multipart/form-data">
