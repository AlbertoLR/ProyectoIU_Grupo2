...
<div class="design">
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item active"><?= i18n("Search Physiotherapist Hour") ?></li>
  </ol>
    <div class="container">
      <h1><?= i18n("Search Physiotherapist Hour")?></h1>
      <form physiotherapisthour="index.php?controller=physiotherapisthour&amp;action=search" method="POST">
      ...
      <div class="form-group">
        <label><?= i18n("Start Time") ?>:</label>
         <input type="time" name="stime" class="form-control" placeholder="ej: 14:00" pattern="([01]?[0-9]|2[0-3]):[0-5][0-9](:[0-5][0-9])?">
      </div>
      <div class="form-group">
        <label><?= i18n("End Time") ?>:</label>
         <input type="time" name="etime" class="form-control" placeholder="ej: 15:00" pattern="([01]?[0-9]|2[0-3]):[0-5][0-9](:[0-5][0-9])?">
      </div>
