...
<div class="design">
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item active"><?= i18n("Search cash") ?></li>
  </ol>
  </div>
    <div class="container">
	  ...
	  <div class="form-group">
        ...
        <input type="text" name="cantidad" class="form-control"  placeholder="ej: 100" pattern="([0-9]+)" >
      </div>
	  ...
	  <div class="form-group">
	   ...
	   <div class="form-group">
         ...
         <input type="text" name="descripcion" class="form-control"  placeholder="ej: Pago de una actividad"  maxlength="90" "pattern="[a-zA-ZñÑáéíóúÁÉÍÓÚ\s]+">
       </div>	
